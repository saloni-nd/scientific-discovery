...
ggsave(paste0(data_folder, "cod_lifespan_external_share_bysex.png"), width=9, height=10)
...
ggsave(paste0(data_folder, "cod_lifespan_external_number_bysex.png"), width=9, height=10)
...
ggsave(paste0(data_folder, "cod_lifespan_external_rate_bysex.png"), width=9, height=10)
